...
class ADWState:
    ...
    def update(self, **kwargs):
        ...
        # Filter to only our core fields (including local-only mode fields)
        core_fields = {
            "adw_id", "issue_number", "branch_name", "plan_file", "issue_class",
            "description", "title"  # Local-only mode fields
        }
    ...
    def to_stdout(self):
        ...
        # Only output core fields (including local-only mode fields)
        output_data = {
            "adw_id": self.data.get("adw_id"),
            "issue_number": self.data.get("issue_number"),
            "branch_name": self.data.get("branch_name"),
